...
# scaffold_linkml_template

A template of the linkml scaffold project

## Documentation Website

[https://Terranexus.github.io/scaffold_linkml_template](https://Terranexus.github.io/scaffold_linkml_template)
...
* [src/](src/) - source files (edit these)
  * [scaffold_linkml_template](src/scaffold_linkml_template)
    * [schema/](src/scaffold_linkml_template/schema) -- LinkML schema
      (edit this)
    * [datamodel/](src/scaffold_linkml_template/datamodel) -- generated
      Python datamodel
