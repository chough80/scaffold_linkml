# Contributing to scaffold_linkml_template

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
scaffold_linkml_template. These guidelines are not strict rules.
...
The scaffold_linkml_template team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the scaffold_linkml_template technical leads
...
[issues]: https://github.com/Terranexus/scaffold_linkml_template/issues/
[pulls]: https://github.com/Terranexus/scaffold_linkml_template/pulls/
