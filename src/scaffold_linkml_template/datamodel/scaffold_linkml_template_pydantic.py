...
linkml_meta = LinkMLMeta({'default_prefix': 'scaffold_linkml_template',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'scaffold_linkml_template': {'prefix_prefix': 'scaffold_linkml_template',
                                               'prefix_reference': 'https://w3id.org/Terranexus/scaffold_linkml_template/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://Terranexus.github.io/scaffold_linkml_template'],
     'source_file': 'src/scaffold_linkml_template/schema/scaffold_linkml_template.yaml',
     'title': 'scaffold_linkml_template'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/Terranexus/scaffold_linkml_template'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/Terranexus/scaffold_linkml_template',
